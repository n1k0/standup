...
USERNAME_RE = r'(?P<slug>[-a-zA-Z0-9_@`\[\]\{\}\^]+)'
...
urlpatterns = [
    ...
    url(r'^user/{}/$'.format(USERNAME_RE), views.UserView.as_view(), name='status.user'),
    ...
    url(r'^user/{}.xml$'.format(USERNAME_RE), cache_feed(views.UserFeed()), name='status.user_feed'),
